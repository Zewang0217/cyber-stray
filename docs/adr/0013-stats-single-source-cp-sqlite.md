...
**4. HUD 显示真实值**：去掉"饥饿 = 100 − 精力"换算皮（重写期发明的映射，无字段依据），四条分段墨条 = 精力/无聊/心情/脾气；`state=null` 显示未知态而非兜底健康值。design-v3 世界宪法（docs/design-v3/DESIGN.md §HUD、components.md §横栏）同步修订。
