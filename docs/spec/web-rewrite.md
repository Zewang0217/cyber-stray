...
> 世界宪法：docs/design-v3 四文档（DESIGN / components / motion / stack）+ demo.html（动效验收基准）。
> 实施会话拿本文档即可开工，无需再做决策。发现本文与宪法冲突时以 docs/design-v3 为准并回修本文。
...
- **视觉验收**：每票产出真实浏览器截图（移动 390 + 桌面 1280）走视觉模型评审；动效对照 docs/design-v3/demo.html 基准；宪法四预算作为 review checklist 项。
