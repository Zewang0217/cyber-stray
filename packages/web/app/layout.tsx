...
/**
 * Direction contract（docs/design-v3 世界宪法，2026-09 重写）：
 *
 * THESIS: 一台掌机（STRAY-BOY），一座像素夜城，一只自己会动的猫（docs/design-v3/DESIGN.md §1）。
 ...
 * FORM: 掌机框架 = 顶栏铭牌 + 主屏（游戏层）+ 底部 4 tab 菜单条 + START 键（docs/design-v3/DESIGN.md §5）。
